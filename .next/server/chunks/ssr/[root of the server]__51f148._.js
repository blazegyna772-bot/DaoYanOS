...
;
const metadata = {
    title: "AI导演制作中台 - DaoYanOS",
    description: "导演级分镜提示词生成系统",
    authors: [
        {
            name: "QiYing"
        }
